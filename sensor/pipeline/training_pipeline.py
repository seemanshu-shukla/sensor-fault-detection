...
class TrainPipeline:
    ...
    def start_data_ingestion(self)->DataIngestionArtifact: #When data ingestion component is completed it will generate the output/artifact. This is the reason why we are defining the return type of this function as DataIngestionArtifact
        try:
    ...
    def run_pipeline(self):
        try:
            ...
            self.sync_artifact_dir_to_s3() #If we are getting any exception that means model evaluation might not get successfully executed. This is the reason why in Exception block we are only syncing arifact dir and not saved_models dir
            TrainPipeline.is_pipeline_running=False
            raise  SensorException(e,sys)
